...
class SellerProductDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function($query){
            $editBtn = "<a href='".route('seller.products.edit', $query->id)."' class='btn btn-primary row' style='margin:0 0 5px 0;'> edit </a>";
    ...
    {
        return $model->where('seller_id', Auth::user()->seller->id)->newQuery(); //security purpose,,, look up ang seller id then authenicate ang user if mag match sya sa current user then fetch ang praoduct ato
