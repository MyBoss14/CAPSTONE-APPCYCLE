...
class FlashSaleItemDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function($query){
            ...
            $deleteBtn = "<a href='".route('admin.flash-sale.destroy', $query->id)."' class='ml-3  btn btn-danger delete-item'> delete </a>";
            ;
            ...
            ->addColumn('show_at_home', function($query){
                if($query->show_at_home == 1){
                    $button = '<label class="custom-switch mt-2">
                    <input type="checkbox" checked name="custom-switch-checkbox" class="custom-switch-input change-at-home-status" data-id="'.$query->id.'">
                    <span class="custom-switch-indicator"></span>
                  </label>';
                }else {
                    $button = '<label class="custom-switch mt-2">
